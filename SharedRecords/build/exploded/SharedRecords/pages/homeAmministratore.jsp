	...
	<% 
	 ...
	 %>
		...
		<ul style="width: 580px;">
			<li><a href="/SharedRecords/pages/homeAmministratore.jsp?nomeStanza=<%= nomestanza %>" style="color: #f00000">Home</a></li>
			<li><a href="/SharedRecords/pages/viewConversazioni.jsp">Conversazioni</a></li>
			<li><a href="/SharedRecords/pages/viewRichieste.jsp?nomeStanza=<%= s.getNome() %>">Richieste</a></li>
			...
			<table class="formdata" id="myTable">
					...
					%>
							...
							<tr>
								...
								<td><%= statoInt %></td>
								<td><form  name="catalogo" id="myform" action="/SharedRecords/richiestaTitolo" method="post">
		...
		<form>
				<input type="submit" name="azione" value="elimina" id="reg"
				style="margin-left: 470px;">
