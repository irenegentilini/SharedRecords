...
<div class="title">
	...
	<h2 style="margin-left:60px;">Messaggi</h2>
...
<%
	...
	for(Utente u : utenti.getUtenti()){
		if(u.getUsername().equals((String)session.getAttribute("utente"))){
...
<form name="formdata" id="myform" action="/SharedRecords/conversazioni" method="post">
